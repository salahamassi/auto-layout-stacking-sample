...
class ViewController: UIViewController {
    ...
    private func createItemStackView(for item: Item) -> UIStackView{
        ...
        let hstack = UIStackView(arrangedSubviews: [quantityLabel, nameLabel, priceLabel])
    ...
    private func createAddtionStackView() -> (stack: UIStackView, nameLabel: UILabel, priceLabel: UILabel){
        ...
        addtionNameLabel.setContentHuggingPriority(.defaultLow, for: .horizontal)
        let addtionStackView = UIStackView(arrangedSubviews: [addtionNameLabel, addtionPriceLabel])
